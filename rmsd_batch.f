...
***   output RMSD ---------------------------->
      ...
      !format('Structure1: ',A10,'  Length= ',I4)
      !write(*,502)pdb(2),nseqB
      !format('Structure2: ',A10,'  Length= ',I4)
      !write(*,503)n_ali
      !format('Number of residues in common= ',I4)
      write(*,513)rmsd
 513  format(F8.3)
      !write(*,514)drmsd
      !format('Distant RMSD of the common residues= ',F8.3)
      !write(*,*)
...
ccccccccccc Calculate dRMSD between 1 and CA
